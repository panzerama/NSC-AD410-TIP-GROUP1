...
<?php
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-title">
                      <h3>Answer Options - Quarter/Year List<br> </h3>
                    </div>
                </div>    <!-- end ibox -->
            </div>    <!-- end col lg 12 -->
        </div>    <!-- end row -->
    ...
    <div class="panel panel-body" align="left">
        <?php for($i = 0, $l = count($answer_qtr_options); $i < $l; ++$i) {
        $quarter = $answer_qtr_options[$i];
        $year = $answer_year_options[$i];
        ?>
            <form>
                <!-- begin row -->
                <div class="row">
                    <!-- col 0 -->
                    <div class="col-sm-3">
                    <textarea class="scrollabletextbox" name="quarter"><?php echo $quarter; ?></textarea>
                    </div>
                    <!-- col 1 -->
                    <div class="col-sm-3">
                    <textarea class="scrollabletextbox" name="year"><?php echo $year; ?></textarea>
                    </div>
                    <!-- col 2 -->
                    <div class="col-sm-1">
