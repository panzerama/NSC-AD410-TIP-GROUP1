...
<?php
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-title">
                      <h3>Answer Options - ELO List<br> </h3>
                    </div>
                </div>    <!-- end ibox -->
            </div>    <!-- end col lg 12 -->
        </div>    <!-- end row -->
    ...
    <div class="panel panel-body" align="left">
        <?php for($i = 0, $l = count($answer_elo_options); $i < $l; ++$i) {
        $elo = $answer_elo_options[$i];
        ?>
            <form>
                <!-- begin row -->
                <div class="row">
                    <!-- col 1 -->
                    <div class="col-sm-6">
                    <textarea class="scrollabletextbox" name="elo"><?php echo $elo; ?></textarea>
                    </div>
