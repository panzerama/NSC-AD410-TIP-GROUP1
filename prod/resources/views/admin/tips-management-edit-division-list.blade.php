...
<?php
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-title">
                      ...
                      <h3>Answer Options - Division List<br> </h3>
    ...
    <div class="panel panel-body" align="left">
        ...
        <?php for($i = 0, $l = count($answer_divion_options); $i < $l; ++$i) {
        $division = $answer_divion_options[$i];
        ?>
            ...
            <form>
                ...
                <div class="row">
                    ...
                    <textarea class="scrollabletextbox" name="division"><?php echo $division; ?></textarea>
        ...
        <?php }; ?>   <!-- end for loop -->
                <div class="row">
                    ...
                    <!-- col 3 -->
                    <div class="col-sm-3">
                        <input type="submit" class="buttoncancel" name="cancel" value="Cancel Changes" />
                    </div>
                    <!-- col 4 -->
                    <div class="col-sm-3">
                        <input type="submit" class="buttonsubmit" name="submit" value="Submit Changes" />
                    </div>
                </div>
                <br>
        </form> 
